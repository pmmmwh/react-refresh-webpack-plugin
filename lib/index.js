...
const { refreshGlobal, webpackVersion, webpackRequire } = require('./globals');
const {
  createError,
  getParserHelpers,
  getRefreshGlobal,
...
const REPLACEMENTS = {
  $RefreshRuntime$: {
    ...
    req: [`${refreshGlobal}.runtime`, webpackRequire],
    type: 'object',
  },
  $RefreshSetup$: {
    expr: `${refreshGlobal}.setup`,
    req: [`${refreshGlobal}.setup`, webpackRequire],
    type: 'function',
  },
  $RefreshCleanup$: {
    expr: `${refreshGlobal}.cleanup`,
    req: [`${refreshGlobal}.cleanup`, webpackRequire],
    type: 'function',
  },
  $RefreshReg$: {
    expr: `${refreshGlobal}.register`,
    req: [`${refreshGlobal}.register`, webpackRequire],
    type: 'function',
  },
  $RefreshSig$: {
    expr: `${refreshGlobal}.signature`,
    req: [`${refreshGlobal}.signature`, webpackRequire],
    type: 'function',
  },
};
