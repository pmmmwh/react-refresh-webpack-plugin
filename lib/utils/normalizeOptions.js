...
const d = (object, property, defaultValue) => {
  return typeof object[property] === 'undefined' ? defaultValue : object[property];
};
...
const nestedOption = (value, fn) => {
  return fn(typeof value === 'undefined' ? {} : value);
};
...
const normalizeOptions = (options) => {
  // Show deprecation notice for the `disableRefreshCheck` option
