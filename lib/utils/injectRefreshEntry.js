...
/** @typedef {{ prependEntries: WebpackEntry, overlayEntries: WebpackEntry }} AdditionalEntries */
 ...
 * @param {AdditionalEntries} additionalEntries An object that contains the Webpack entries for prepending and the overlay feature
