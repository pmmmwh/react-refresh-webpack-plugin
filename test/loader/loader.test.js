...
describe('loader', () => {
  it('should work for CommonJS', async () => {
    const [compilation] = getCompilation('./index.cjs.js');
    ...
    expect(execution).toMatchInlineSnapshot(`
      ...
      },[[\\"./index.cjs.js\\",\\"runtime\\",\\"vendors-node_modules_react-refresh_runtime_js\\"]]]);"
    `);
  ...
  it('should work for ES Modules', async () => {
    const [compilation] = getCompilation('./index.esm.js');
    await compilation.run();
    ...
    expect(execution).toMatchInlineSnapshot(`
      ...
      },[[\\"./index.esm.js\\",\\"runtime\\",\\"vendors-node_modules_react-refresh_runtime_js\\"]]]);"
    `);
  ...
  it('should generate valid source map when the `devtool` option is specified', async () => {
    const [compilation] = getCompilation('./index.cjs.js', { devtool: 'source-map' });
    await compilation.run();
